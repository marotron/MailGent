# Ship candidate `2026-08-23-copper`
...
- SVG `.scratch/app-icon/candidates/2026-08-23-copper.svg` — **full 1024 plate**, glyph already on the 824 keyline
- PNG `.scratch/app-icon/candidates/2026-08-23-copper.png`
- Template (menu bar) `.scratch/app-icon/candidates/2026-08-23-copper-template.svg` + `-template.png` — black glyph, alpha holes, no plate
- State `.scratch/app-icon/candidates/2026-08-23-copper.json`
...
1. Confirm `pick.json` slug is `2026-08-23-copper`.
2. Resize `2026-08-23-copper.png` into `MailGent/Assets.xcassets/AppIcon.appiconset/` (same filenames, no extra keyline):
- icon_16x16.png (16px)
...
- Stamp, MCP preview, or compile a different candidate than `2026-08-23-copper`.
