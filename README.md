...
**0.1.2 alpha** — macOS menu-bar companion beside Apple Mail. Not a daily client. No built-in AI. External agents talk to MailGent over MCP.
...
- Menu status times sit in chips; Changes says yesterday or the date when the window is not today; Last agent call uses clock + elapsed like Last ingest
